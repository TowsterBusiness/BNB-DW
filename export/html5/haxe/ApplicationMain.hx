...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BNB-DateWeek", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BNB-DateWeek", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "BNB-DateWeek";
		app.meta["name"] = "BNB-DateWeek";
